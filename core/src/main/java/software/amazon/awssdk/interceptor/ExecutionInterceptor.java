 ...
 *     {@link ClientOverrideConfiguration.Builder#addLastExecutionInterceptor(ExecutionInterceptor)} method.</li>
 *
 ...
 *     {@link ClientOverrideConfiguration.Builder#addLastExecutionInterceptor(ExecutionInterceptor)}, in the order they were
 *     added.</li>
 * </ol>
...
public interface ExecutionInterceptor {
     ...
     *
     * This method is guaranteed to be executed on the thread that is making the service call. This is true even if a non-blocking
     * I/O client is used. This is useful for transferring data that may be stored thread-locally into the execution's
     * {@link ExecutionAttributes}.
     *
     * @param execution The current state of the execution, including the unmodified SDK request from the service client call.
     ...
     *
     * @param execution The current state of the execution, including the current SDK request from the service client call.
     * @param executionAttributes A mutable set of attributes scoped to one specific request/response cycle that can be used to
     *                            give data to future lifecycle methods.
     ...
     *
     * @param execution The current state of the execution, including the SDK request (potentially modified by other interceptors)
     ...
     *
     * @param execution The current state of the execution, including the SDK and unmodified HTTP request.
     * @param executionAttributes A mutable set of attributes scoped to one specific request/response cycle that can be used to
     *                            give data to future lifecycle methods.
     */
     ...
     *
     * @param execution The current state of the execution, including the SDK and current HTTP request.
     * @param executionAttributes A mutable set of attributes scoped to one specific request/response cycle that can be used to
     *                            give data to future lifecycle methods.
     * @return The potentially-modified HTTP request that should be sent to the service. Must not be null.
     */
    default SdkHttpFullRequest modifyHttpRequest(BeforeTransmissionContext execution, ExecutionAttributes executionAttributes) {
     ...
     *
     * Note: Unlike many other lifecycle methods, this one may be invoked multiple times. If the {@link RetryPolicy} determines
     * a request failure is retriable, this will be invoked for each retry attempt.
     *
     * @param execution The current state of the execution, including the SDK and HTTP request (potentially modified by other
     ...
     *
     * It is possible that the HTTP client could have already modified this response, so debug-level wire logging should be
     ...
     *
     * @param execution The current state of the execution, including the SDK and HTTP requests and the unmodified HTTP response.
     * @param executionAttributes A mutable set of attributes scoped to one specific request/response cycle that can be used to
     *                            give data to future lifecycle methods.
     */
     ...
     * the error code returned by the service is retriable, this will be invoked for each response returned by the service.
     *
     * @param execution The current state of the execution, including the SDK and HTTP requests and the current HTTP response.
     * @param executionAttributes A mutable set of attributes scoped to one specific request/response cycle that can be used to
     *                            give data to future lifecycle methods.
     ...
     * the error code returned by the service is retriable, this will be invoked for each response returned by the service.
     *
     * @param execution The current state of the execution, including the SDK and HTTP requests as well as the (potentially
    ...
    /**
     * Read the SDK response as it was returned by the unmarshaller, before it is modified by other interceptors.
     * {@link #afterExecution} should be used in most circumstances for reading the SDK response because it includes
     * modifications made by other interceptors.
     *
     * @param execution The current state of the execution, including the SDK and HTTP requests and the HTTP response.
     * @param executionAttributes A mutable set of attributes scoped to one specific request/response cycle that can be used to
     *                            give data to future lifecycle methods.
     */
    ...
    /**
     * Modify the {@link SdkHttpFullRequest} before it is returned by the client.
     *
     * @param execution The current state of the execution, including the SDK and HTTP requests as well as the SDK and HTTP
     *                  response.
     * @param executionAttributes A mutable set of attributes scoped to one specific request/response cycle that can be used to
     *                            give data to future lifecycle methods.
    ...
    /**
     * Read the finalized SDK response as it will be returned by the client invocation.
     *
     * @param execution The current state of the execution, including the SDK and HTTP requests as well as the SDK and HTTP
     *                  response.
     * @param executionAttributes A mutable set of attributes scoped to one specific request/response cycle that can be used to
     ...
     *
     * @param execution The context associated with the execution that failed. An SDK request will always be available, but
